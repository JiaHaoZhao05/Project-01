...
int main() {
	...
	while (!WindowShouldClose() && !quit) {
		...
		EndDrawing();
		if (!menu) { //1->Coin, 2->Mushroom, 3->Double Jump, 4->Star, 5->Giant Mushroom
			string map = (
				"0"
				"0"
				"...............................................................................................1..............3...................21..................................................................................0"
			...
			while (!WindowShouldClose() && Mario.lives > 0 && distance < 15300)// run the loop untill the user presses ESCAPE or presses the Close button on the window
			{
				...
				for (int i = 0; i < level1.collisions.size(); ++i) { // collision with power ups

					level1.collisions[i]->GiantDestroy(Mario.GetRect());
